...
## Quick Overview
This is a package for Mathematica 9.0 that generates and verifies digital signatures based on ECDSA standard domain parameters `secp256k1`. The main functions are:
